/**
 * @license AngularJS v1.2.14-build.local+sha.1b1413a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.14-build.local+sha.1b1413a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.14-build.local+sha.1b1413a',    // all of these placeholder strings will be replaced by grunt's
